  ...
  const head = () => (
    <Head>
      ...
      <meta
        ...
        content={`Best Catagory for ${catagory.name}`}
      />
      <meta property='og:type' content='website' />
      <meta
        property='og:url'
        content={`${DOMAIN}/catagories/${catagory.slug}`}
      />
          ...
          <div className='container-fluid text-center'>
            <header>
              <div className='col-md-12 pt-3'>
                <h1 className='display-4 font-weight-bold'>{catagory.name}</h1>
                {blogs.map((b, i) => (
                  <div>
                    <Card key={i} blog={b} />
                    <hr />
